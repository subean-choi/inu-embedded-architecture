...
= 우선순위가 낮은 프로그램은 우선순위가 높은 프로그램이 쉴 때만 조작되는 상태
### 롬 바이오스(ROM BIOS) 역할
- 컴퓨터 시스템의 <span color="blue">부팅에 관계</span>
- 운영체제를 도와 <span color="blue" underline="true">하드웨어를 저수준 제어</span>
### 콜드(cold)부트 의미
...
[image omitted: personal or temporary Notion asset]
### 스트라이핑 개념
= 여러 개의 디스크에 데이터를 똑같은 스트라이프 크기로 나누어<span color="blue"> 분산 저장</span>
# Lecture Note 26
### 등선 속도 방식 특성
